...
class longestPostByCharecterPerMonthTest extends \Codeception\Test\Unit
{
    /**
    ...
    // tests
    public function testLongestPostByCharacterPerMonth()
    {
        ...
        $ag = new \Gumeniukcom\Aggregator\LongestPostByCharacterPerMonth($this->getLogger());
        ...
        $this->assertEquals(mb_strlen('message_111'), $result['2020.03']);
        $this->assertEquals(mb_strlen('message_11111111111фуубар👍👍😕🙂🔥🎈🎉😔🤗😬😭😃'), $result['2020.10']);
